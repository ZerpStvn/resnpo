            ...
            <div class="detail-payment-container tab" id="A">
              ...
              <div class="second-payment-section">
                <ul class="flex ul-first-payment gap-15">
                  <li>
                    <button><p class="w-500 p-25">3,000円/月</p></button>
                  </li>
                  <li>
                    <button><p class="w-500 p-25">10,000円/月</p></button>
                  </li>
                </ul>
                <ul class="flex ul-second-payment gap-15">
                  <li>
                    <button><p>1,000円/月</p></button>
                  </li>
                  <li>
                    <button><p>5,000円/月</p></button>
                  </li>
                  <li>
                    <button><p>30,000円/月</p></button>
                  </li>
                  <li>
                    <button><p>50,000円/月</p></button>
                  </li>
                  <li>
                    <button><p>100,000円/月</p></button>
                  </li>
                </ul>
              </div>
            ...
            <div class="detail-payment-container tab hidden" id="C">
              <div class="third-tab">
                ...
                <div class="shipping-address">
                  ...
                  <div class="address">
                    <strong><p>NPO法人RES NPO法人RES 物流センター（事務太郎内） </p></strong>
                    <p>〒790-0951</p>
                    <p>愛媛県松山市天山3丁目9-30</p>
