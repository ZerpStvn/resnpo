  ...
  <section class="front-section">
    <div class="front-section-content">
      ...
      <p class="text-justified">
        新学習指導要綱に記載されている「持続可能な社会の創り手」を育成するために、地域社会のSDGs課題に焦点を当て、その解決に向けて研究や活動を行う高校生たちが、その取り組みの経過や成果をプレゼンテーション等で競う場を提供します。 私たちが求めるのは単なる知識の獲得や表彰の場ではありません。ESD（持続可能な開発のための教育）実践の場として、「世代や立場を超えた交流」「一緒に取り組む仲間との交流」「自ら考え行動する大切さ」「行動（実体験）による学び」「情報発信と新たな関係の構築」の経験やその価値観を深める機会を通じて、未来を担う若者たちの成長を促します。


        します
    </div>
    <div class="front-section-image">
      <img src="<?php echo RESNPO_IMAGE . '/header-mission.png' ?>" alt="">
    </div>
  </section>
    ...
    <div class="main-feature-container">
      ...
      <div class="feature-card-container">
        <div class="feature-card">
          <img src="<?php echo RESNPO_IMAGE . '/feature1.png' ?>" alt="Project Image 1">
