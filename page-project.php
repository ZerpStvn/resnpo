...
<div id="projectid">
  ...
  <main class="global-width">
    ...
    <div id="proj-sa">
      <?php render_projects_cards('海外留学', '「海外留学/ツアー」の過去実績をご紹介します。', '様々な活動を通して日本と東南アジアの学生をつなぐ活動を主として行っています。同年代の仲間たちとの様々な活動や異文化体験を通じて、国内では経験できない多様性に触れ、自国や自分自身の新たな面に気づかされます。', '/pp-3.png', '/study-abroad') ?>
    </div>
