...
<div id="projectid">
  ...
  <section class="section-project-sgds relative">
    <div class="relative project-sgds-container">
      ...
      <p class="w-700 p-200 white-clr section-title relative">SGDS</p>
  ...
  <div class="relative project-sgds-container">
      ...
      <p class="w-700 p-150 section-head-clr section-title-study relative">海外留学</p>
      ...
      <div class="overlay-arc-study relative">
        ...
        <ul class="flex">
          <li>
            <p class="w-700 p-60 sub-head-clr">「海外留学/ツ<br> アー」の過去実績<br>をご紹介します。</p>
          </li>
          <li>
  ...
  <section class="section-project-sgds relative">
    <div class="relative project-sgds-container">
      ...
      <p class="w-700 p-150 white-clr section-title relative">海外進学</p>
